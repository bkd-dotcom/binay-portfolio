...
const Education = () => (
  ...
  >
    ...
    <motion.div
      className="bg-white/70 rounded-lg shadow-xl p-6 border border-gray-100 max-w-2xl mx-auto relative z-10 hover:scale-105 transition-transform backdrop-blur-md"
